// Supabase Edge Function — admin-schedule-project-creations (admin caller)
//
...
//
// Local:  supabase functions serve admin-schedule-project-creations
// Deploy: supabase functions deploy admin-schedule-project-creations
...
Deno.serve(async (req) => {
  ...
  if (truncated) {
    console.warn(
      `admin-schedule-project-creations: ${ids.length} ids submitted, truncating to ${MAX_ROWS}`,
    );
  }
