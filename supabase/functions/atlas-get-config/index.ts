// Supabase Edge Function — atlas-get-config (artificial caller / agent)
//
...
// bearer + X-Internal-Caller header. Mirrors atlas-update-unit-data /
// atlas-save-place-media gating. GET or POST (no body needed).
//
// Local:  supabase functions serve atlas-get-config
// Deploy: supabase functions deploy atlas-get-config
