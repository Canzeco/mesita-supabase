// Supabase Edge Function — consumer-recommend-swipe (natural caller)
//
...
//
// Local:  supabase functions serve consumer-recommend-swipe
// Deploy: supabase functions deploy consumer-recommend-swipe
...
Deno.serve(async (req) => {
  ...
  const ranked = await invokeArtificialCaller<{
    ...
    summary?: unknown;
    error?: string;
  }>(env, "consumer-recommend-swipe", "recommender-rank-swipe", {
    lat: body.lat,
    lng: body.lng,
