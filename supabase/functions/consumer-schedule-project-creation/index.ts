// Supabase Edge Function — consumer-schedule-project-creation (consumer caller)
//
...
//
// Local:  supabase functions serve consumer-schedule-project-creation
// Deploy: supabase functions deploy consumer-schedule-project-creation
