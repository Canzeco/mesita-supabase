// Supabase Edge Function — admin-create-project (admin caller / LIVE admin create path)
//
...
// enricher-save-project-data (places+units, content_status='generating') →
...
//
// Local:  supabase functions serve admin-create-project
// Deploy: supabase functions deploy admin-create-project
...
Deno.serve(async (req) => {
  ...
  // Enricher flips it to 'ready' via enricher-update-project-data. No businesses
