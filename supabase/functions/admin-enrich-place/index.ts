...
// persists via enricher-update-project-data + enricher-save-place-media, flipping the unit
...
Deno.serve(async (req) => {
  ...
  // Enricher re-runs; it flips to 'ready' on completion via enricher-update-project-data.
