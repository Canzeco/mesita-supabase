...
// (camelCase keys, opening-hours array, numeric price level). Field mask
// is intentionally tight to keep per-call cost down; anything else we
// want from Google should be added here, not in any natural caller.
//
